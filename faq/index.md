...
* [Cannot create thumbnails.]({% link faq/thumbnails.md %})
...
* [I forgot my password and cannot log in.]({% link faq/password.md %})
* [I deleted the file data/config.ini.php.]({% link faq/config-ini-php.md %})

## Migrating from PhpGedView to webtrees ##

* [Letters with accents have become corrupted, so é becomes Ã©, è becomes Ã¨, and so on.]({% link faq/pgv-accents.md %})
* [After migrating, I cannot login with my admin account]({% link faq/pgv-login.md %})
* [Embedded HTML no longer appears processed before display]({% link faq/pgv-html.md %})
* [How to run the transfer wizard again]({% link faq/pgv-wizard.md %})

## Synology servers ##

* [iconv() Wrong charset, conversion from 'utf-8' to 'utf-16be' is not allowed]({% link faq/synology-iconv.md %})
