...
In webtrees versions 2.0–2.1, there was a tool in the control panel to help find and import custom thumbnails.
If you need to import them, you should upgrade to 2.1 first, and then upgrade to a later version.
